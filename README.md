...
### Limitaciones
EL programa cuenta con las siguientes limitaciones.
...
El programa tiene los siguientes requisitos de sistema. 
- Sistema operatico Linux (probado en distribuciones basadas en Debian/Ubuntu)
- Entorno de escritorio compatible con GTK3

### Dependencias
EL programa tiene las siguientes dependencias de biblioteas o programas.
